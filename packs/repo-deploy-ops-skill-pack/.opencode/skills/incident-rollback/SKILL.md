...
description: 处理部署失败、上线后故障、健康检查异常、接口错误、日志爆红等事件，优先止血、判断是否回滚、执行回滚并形成 incident/rollback 记录。Use when a deployment goes wrong or a running service must be stabilized quickly.
